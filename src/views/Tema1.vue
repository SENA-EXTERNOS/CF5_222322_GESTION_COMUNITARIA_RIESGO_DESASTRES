  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5.mb-5
    .titulo-principal.color-acento-contenido
      .titulo-principal__numero
        span 1
      h1 Evaluación de incidentes

    .row.container.justify-content-around.align-items-center

      .row
        figure
              img(src="@/assets/curso/temas/imagen-fondo-tarj1-tema1.png").imagen-fondo-tarjeta1-tema1
    ...
    .row.container.justify-content-around.align-items-center
        ...
        .row
          .col-lg-7
            p Los incidentes deben ser clasificados según su nivel de afectación, dando prioridad a las zonas que tuvieron mayores daños, sin dejar a un lado las personas que sufrieron repercusiones menores en su salud y en su estructura física. La evaluación permitirá establecer los recursos que se necesitan para la recuperación de la zona en donde ocurrió la situación de emergencia, con el fin de resarcir a todas las víctimas de igual manera, prestando servicio de ayudas psicológicas, económicas y de reubicación en caso de ser necesario. 
            
            .cajon.color-primario.p-3
              p #[strong La información recopilada dentro de las primeras ocho horas permite dar respuesta a las necesidades más urgentes para que se aliviane el sufrimiento humano de las poblaciones afectadas. Es de vital importancia contar a su vez con los datos que se recolecten en las siguientes 48 a 72 horas después del desastre, para así cuantificar los costos de los daños y los recursos que serán necesarios para su reconstrucción.]
            br

          .col-lg-5

            figure
                img(src="@/assets/curso/temas/imagen-prim-aux-tema1.png")
        br
    ...
    .row.container.justify-content-around.align-items-center
        ...
        .bg--img_03.bloque-acordeon-tema1
          .row.justify-content-center.mb-4
            ...
            .col-lg-8
              AcordionA.mb-5(tipo="a" clase-tarjeta="tarjeta acordeonA").tarjeta.fondo-acordeon-tema1
                .row(titulo="Mando:")
                  .col-12
                    ul.lista-ul.lista-acordeon-tema1
                      li 
                        i.fas.fa-circle
                ...
                .row(titulo="Planificación y estructura organizacional:")
                  .col-12
                ...
                .row(titulo="Instalaciones y recursos:")
                  .col-12
                ...
                .row(titulo="Manejo de las comunicaciones e información:")
                  .col-12
    ...
    .row.container.justify-content-around.align-items-center.mt-5
        ...
        .row.fondo-tarjeta-inferior-acordeon-tema1.tarjeta.p-4
          figure
                img(src="@/assets/curso/temas/fondo-imagen-tarjeta-inf-acordeon-tema1.png", alt="alt").fondo-img-der-tarjeta-inferior-acordeon-tema1
    ...
    .row.container.justify-content-around.align-items-center
      ...
      SlyderF(columnas="col-lg-6")
        ...
        .tarjeta.tarjetas-carrusel.color-primario.p-4.h-100
          ...
          h2.text-center Equipo de intervención: 
    ...
    .row.container.justify-content-around.align-items-center.fondo-tarjeta-info-estatica
      ...
      .row
        .col-lg-8.fondo-izq-tarjeta-eval-danos
          p(data-aos="fade-left").texto-tarjeta-eval-danos.p-4 Todos los países de Latinoamérica tienen definido un sistema de atención y prevención de desastres, dentro del que se incluye al sector salud, el cual participa en la toma de decisiones dentro del comité operativo de emergencia. Esta instancia es la encargada de coordinar los diferentes sectores involucrados para la toma de decisiones en situaciones de crisis.

        .col-lg-4.fondo-der-tarjeta-eval-danos
